  <section> 
   ...
   <div id="capa_para_edicion" class="div_contenido" > 
    ...
    <div class="margin"  id="botones_control" >
      ...
      <button type="button" class="btn btn-primary" onclick="mostrarseccion(3);" >Expericencia</button>
<!--       <button type="button" class="btn btn-primary" onclick="mostrarseccion(4);" >Proyectos</button>
 -->      <button type="button" class="btn btn-primary" onclick="mostrarseccion(5);" >Documentos</button>

              ...
              <div class="box box-info">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td>1</td>
                      <td>Reporte de Usuarios por Especialidad</td>
                      <td><a href="crear_reporte_porpais/1/2" target="_blank" ><button class="btn btn-block btn-primary btn-xs">Ver</button></a></td>

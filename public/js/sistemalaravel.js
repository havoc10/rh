...
//funcion que carga todos los formularios del sistema
    ...
    if(arg==4){ var url = "form_nueva_especialidad";  }
...
//funcion para atrapar los formularios y enviar los datos
       ...
       e.preventDefault();
        ...
        if(quien=="f_nueva_especialidad"){ var varurl="form_add_especialidad"; var divresul="notificacion_resul_fae"; rs=true; sel=4;}
        ...
        if(quien=="f_agregar_experiencia_laboral"){ var varurl="agregar_experiencia_laboral_usuario"; var divresul="notificacion_resul_fael";  rs=true; }  //leccion 10
        if(quien=="f_borrar_usuario"){ var varurl="borrar_usuario"; var divresul="notificacion_resul_fbu"; rs=true;}
        ...
        $("#"+divresul+"").html($("#cargador_empresa").html());
              ...
              $.ajax({
                    ...
                    success : function(resul){
                        ...
                        if(quien=="f_nueva_especialidad"){ cargarformulario(sel);}
                        if(quien=="f_agregar_experiencia_laboral"){ mostrarseccion(seccion_sel);}
                        if(quien=="f_borrar_usuario"){ cargarlistado(1);}
                    ...
                    // $(".nombres").addClass("has-error").append("<span class='help-block'>"+errors.nombres+"</span>");       
...
$(document).on("submit",".formarchivo",function(e){
        ...
        var miva=$('#file').val();
        miva2= miva.slice(-4);
        ext_validas = new Array(".png", ".jpg", ".doc"); 
        ...
        if (miva2 == ext_validas[0] || miva2 == ext_validas[1] || miva2 == ext_validas[2]) {
          if(nombreform=="f_agregar_archivo"){
           var miurl="agregar_archivos_persona";  var divresul="notificacion_resul_ar"; rs=false; 
          }
        }
        else{
          if(nombreform=="f_agregar_archivo"){  var miurl="agregar_archivos_persona";  var divresul="notificacion_resul_ar"; rs=true; }
        }
...
function mostrarseccion(arg){
  ...
  if(arg==3){ var url = "form_experiencia_laboral_usuario/"+id_usuario+""; } //leccion 11
  if(arg==4){ var url = "form_proyectos_usuario/"+id_usuario+""; } //leccion 11
  if(arg==5){ var url = "form_archivos_persona/"+id_usuario+""; } //leccion 11
...
function borrarpublicacion(arg){
  var url="borrar_archivo/"+arg+"" ;
  var divresul="notificacion_resul_ar";
  $("#"+divresul+"").html($("#cargador_empresa").html());
...
function borrarexplab(arg){
  var url="borrar_experiencia_laboral/"+arg+"" ;
  var divresul="notificacion_resul_fael";
  $("#"+divresul+"").html($("#cargador_empresa").html());
...
function borrar_especialidad(arg){
  var url="borrar_especialidad/"+arg+"" ;
  var divresul="notificacion_resul_faprd";
  $("#"+divresul+"").html($("#cargador_empresa").html());
...
function borrar_usuario(arg){
  ...
  var divresul="notificacion_resul_fbu";
  $("#"+divresul+"").html($("#cargador_empresa").html());
...
function buscarusuario(){
  ...
  var espec=$("#select_filtro_espec").val();
  var dato=$("#dato_buscado").val();
      if(dato == "")
    {  
      var url="buscar_usuarios/"+espec+"";
    }
    else
    {
      var url="buscar_usuarios/"+espec+"/"+dato+"";
    }
